...
def train_fun():
    Network = network.network_dqn_11_temporal.DQN_Network11_Temporal_LSTM3_Revisit
    ...
    Trainer = trainer_p3d.P3DTrainer_Temporal_Revisit.P3DTrainer
    out_folder = "out_p3d_random_env_spacial_lstm_revisit_penality"
    in_folder = ""
    ...
    # Agent
    agent = Agent(config, is_add_revisit_map=True)
    ...
    trainer.train(is_sph_pos=False, is_randomize=True, is_global_known_map=False, is_egocetric=False,
                  ...
                  randomize_control=True, is_spacial=False, seq_len=seq_len, is__save_path=False,
                  is_stop_n_zero_rewards=False, is_add_negative_reward=False, is_map_diff_reward=False,
                  is_revisit_penalty=True)
