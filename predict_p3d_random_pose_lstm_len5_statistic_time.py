...
def train_fun():
    ...
    Trainer = trainer_p3d.P3DTrainer_Temporal_Statistic_Time.P3DTrainer
    out_folder = "out_p3d_random_step_len_5_36_action_predict_model_440_statistic_time"
    input_dir = "/media/zeng/Workspace/results_paper/out_p3d_final"
    in_folder = os.path.join(input_dir, "out_p3d_random_step_len_5_36_action")
    # network
