...
def train_fun():
    Network = network.network_dqn_11_temporal.DQN_Network11
    ...
    out_folder = "out_p3d_random_ddqn_36_action_with_scheduler"
    in_folder = ""
    # network
    ...
    trainer.train(is_randomize=True, randomize_control=True, randomize_from_48_envs=False,
