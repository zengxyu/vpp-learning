...
class WorkerTrainer:
    ...
    def train_worker(self, num_episode):
        ...
        for i_episode in range(num_episode):
            ...
            pose_delta, rotation_delta = self.get_robot_pose_delta()
            ...
            while not done:
                ...
                # 这里构造奖励
                intrinsic_pose_reward = 109 - np.linalg.norm(pose_delta)
    ...
    def get_robot_pose_delta(self):
        ...
        return pose_delta, rotation_delta
