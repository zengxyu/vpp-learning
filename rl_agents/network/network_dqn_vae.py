...
class DQN_Network11_VAE_Time2(torch.nn.Module):
    def __init__(self, action_size, batch_size=128):
        super().__init__()
        self.in_channels = 15
        self.out_channels = 24
    ...
    def init_encode_layer(self):
        ...
        self.frame_con2 = torch.nn.Conv2d(24, 48, kernel_size=4, stride=2, padding=1)
        self.frame_con3 = torch.nn.Conv2d(48, 24, kernel_size=3, stride=2, padding=1)
