...
from rl_agents.memory.data_structures import SumTree
...
class PriorityReplayBuffer:
    ...
    def __init__(self, buffer_size, batch_size, device, seed=1337):
    ...
    def add_experience(self, state, action, reward, next_state, done):
        """Eg. state = [robot_pose, observation]"""
    ...
    def sample(self, num_experiences=None, is_weighted=True):
