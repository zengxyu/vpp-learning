...
class SAC(BaseAgentAC):
    """Soft Actor-Critic model based on the 2018 paper https://arxiv.org/abs/1812.05905 and on this github implementation
      ...
      to maximise the entropy of their action_space as well as their cumulative reward"""
    agent_name = "SAC"
    ...
    def __init__(self, config):
        ...
        self.critic_local_2 = self.create_critic_network( action_dim=self.action_size, output_dim=1)
