...
def load_dqn_args():
    ...
    config = Config().load_configs(yaml_path="configs/default_dqn.yaml", parser_config=parser_config)
    return parser_config, config


def load_ac_args():
    parser_config = process_args()
    config = Config().load_configs(yaml_path="configs/default_ac.yaml", parser_config=parser_config)
    return parser_config, config
