...
def train_fun():
    ...
    out_folder = "out_p3d_static_step_len_10_36_action_predict_model_550_keep_training"
    ...
    memory = pickle.load(open(os.path.join(in_folder, "experience", "buffer.obj"), "rb"))
    agent.memory = memory
