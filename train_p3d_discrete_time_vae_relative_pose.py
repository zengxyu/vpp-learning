...
from train.P3DTrainer_vae_Temporal_relative_pose import P3DTrainer
...
def build_ddqn_per():
    Network = network.network_dqn_vae.DQN_Network11_VAE_Time
    ...
    out_folder = "output_p3d_ddqn_per26"
    in_folder = ""
