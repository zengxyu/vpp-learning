...
from train.P3DTrainer_vae import P3DTrainer
...
def build_ddqn_per():
    Network = network.network_dqn_vae.DQN_Network11_VAE
    Agent = agents.DQN_agents.Agent_DDQN_PER_VAE.Agent_DDQN_PER_VAE
    Field = field_p3d_discrete.Field
    Action = action_space.ActionMoRo12

    out_folder = "output_p3d_ddqn_per23"
    in_folder = ""
...
def train_fun(tuning_param):
    ...
    # trainer.agent.load_model(index=51)
