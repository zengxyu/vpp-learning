...
def main_loop():
    ...
    for i in range(0, episodes):
        ...
        while not done:
            action = player.get_action(observed_map, np.append(destination-robot_pose[:3], robot_pose[:4]))
            ...
            #
            reward2 = 0
            if get_euclidean_distance(robot_pose_prime[:3], destination) < 3:
                reward2 = 10
            # elif get_euclidean_distance(robot_pose_prime[:3], destination) < 3:
            #     reward2 = 8
            # elif get_euclidean_distance(robot_pose_prime[:3], destination) < 5:
            #     reward2 = 6
            # elif get_euclidean_distance(robot_pose_prime[:3], destination) < 10:
            #     reward2 = 4
            # elif get_euclidean_distance(robot_pose_prime[:3], destination) < 15:
            #     reward2 = 2
            # elif get_euclidean_distance(robot_pose_prime[:3], destination) < 25:
            #     reward2 = 1
            # current_distance = get_euclidean_distance(robot_pose_prime[:3], destination)
            # reward2 = pre_distance - current_distance
