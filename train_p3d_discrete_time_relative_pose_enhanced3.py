...
from train.P3DTrainer_vae_temporal import P3DTrainer
...
def build_ddqn_per():
    Network = network.network_dqn_vae.DQN_Network11_Time_enhanced3
    Agent = agents.DQN_agents.Agent_DDQN_PER_Temporal.Agent_DDQN_PER_Temporal
    Field = field_p3d_discrete_unknown_reward.Field
    Action = action_space.ActionMoRo12

    out_folder = "output_p3d_ddqn_per_with_unknown_cells_random_no_vae"
    in_folder = ""
