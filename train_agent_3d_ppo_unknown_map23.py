...
def main_loop():
    ...
    for i in range(0, episodes):
        ...
        while not done:
            tmp = destination-robot_pose[:3]
            action = player.get_action(observed_map, np.append(tmp, robot_pose[:4]))
            ...
            #
            reward2 = -6
            if get_euclidean_distance(robot_pose_prime[:3], destination) < 1:
                reward2 = 12
