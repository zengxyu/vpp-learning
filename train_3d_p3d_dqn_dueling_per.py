...
config.network = network.network_dqn.DQN_Network11_Dueling
config.agent = agents.DQN_agents.Dueling_DDQN_With_Prioritised_Experience_Replay.Dueling_DDQN_With_Prioritised_Experience_Replay
config.field = field_env_3d_unknown_map2.Field

# output
config.folder['out_folder'] = "output_p3d_dqn_dueling"
