...
def train_fun():
    ...
    out_folder = "out_p3d_random_step_len_5_36_action_predict_keep_training_model_440"
    in_folder = "output/out_p3d_random_step_len_5_36_action"
    # network
    ...
    agent.load_model(440)
    # memory = pickle.load(open(
    #     "/Users/weixianshi/PycharmProjects/vpp-learning/output/out_p3d_random_step_len_5_36_action/experience/buffer.obj",
    #     "rb"))
    # agent.memory = memory
