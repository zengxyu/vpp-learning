...
class Epsilon_Greedy_Exploration(Base_Exploration_Strategy):
    ...
    def __init__(self, hyperparameters):
        ...
        if "exploration_cycle_episodes_length" in self.hyperparameters.keys():
            print("Using a cyclical exploration strategy")
            self.exploration_cycle_episodes_length = self.hyperparameters["exploration_cycle_episodes_length"]
        else:
