...
params = {
    ...
    'output': "output_ppo_unknown_map3",
    ...
    for i in range(0, episodes):
        ...
        while not done:
            ...
            if done:
                ...
                print("mean found target:{}".format(np.sum(rewards1)))
                # print("mean rewards2:{}; new visit cell num: {}".format(np.sum(rewards2), np.sum(rewards2) / r_ratio))
                print("mean free cell:{}".format(np.sum(rewards3)))

                print("mean reward :{}".format(np.sum(rewards1) + ratio * np.sum(rewards3)))
                rewards1 = []
                rewards2 = []
                rewards3 = []
