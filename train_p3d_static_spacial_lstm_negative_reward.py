...
def train_fun():
    ...
    out_folder = "p3d_static_env_seq_len_10_spacial_lstm_action_36_negative_reward"
    in_folder = ""
    # network
    ...
    trainer.train(is_sph_pos=False, is_randomize=False, is_global_known_map=False, is_egocetric=False,
                  ...
                  randomize_control=False, is_spacial=True, seq_len=seq_len, is_add_negative_reward=True,
                  is__save_path=False, is_stop_n_zero_rewards=False, is_map_diff_reward=False)
