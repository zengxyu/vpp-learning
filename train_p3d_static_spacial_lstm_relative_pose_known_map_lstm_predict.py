...
def train_fun():
    ...
    out_folder = "out_p3d_static_spacial_relative_pose_known_map_lstm2"
    in_folder = "output/out_p3d_static_spacial_relative_pose_known_map_lstm"
